...
from app.api.deps import build_onboarding_service, require_self
...
async def complete_onboarding(
    ...
    the partial unique index fires on a duplicate active goal; 422 for
    invalid input (handled by Pydantic upstream of this handler); 403
    when the JWT does not match the path athlete.
    """

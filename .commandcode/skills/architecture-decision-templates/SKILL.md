...
Write it to `docs/adr/NNN-<slug>.md` using the write_file tool, where
...
After writing the ADR, call `refresh_architecture` via the MCP tool to index it.
Then reference it in the implementation plan's **Architecture Contracts**

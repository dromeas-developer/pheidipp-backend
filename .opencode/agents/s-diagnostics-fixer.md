---
description: >-
  Invoked via Task by p-coder-batch-mode, p-coder-fix-mode, or p-test-architect at the end of
...
mode: subagent
model: opencode-go/deepseek-flash-v4
temperature: 0.1
...
- **Plan-based mode** — invoked by `p-coder-batch-mode`, `p-coder-fix-mode`, or `p-test-architect` at the
...
`p-devops` owns runtime/build/test diagnostics; `p-coder-fix-mode` owns
